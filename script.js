...
const ALL_TASKS = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: "Hostová část = 255",
      },
      {
        key: "gateway",
        label: "Typická gateway",
        type: "text",
        answer: "10.5.3.1",
        hint: "První IP v podsíti",
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        hint: "/26 = 192 ve 4. oktetu",
      },
      {
        key: "hosts",
        label: "Max. počet hostů",
        type: "text",
        answer: "62",
        hint: "2^6 - 2 = 62",
      },
  ...
  },
  {
    ...
    fields: [
      {
        key: "fa00",
        label: "Fa0/0 IP adresa",
        type: "text",
        answer: "192.168.1.1",
        hint: "První host v .1.0/24",
      },
      {
        key: "maska00",
        label: "Fa0/0 maska",
      ...
      {
        key: "fa01",
        label: "Fa0/1 IP adresa",
        type: "text",
        answer: "10.0.0.1",
        hint: "První host v 10.0.0.0/8",
      },
      {
        key: "maska01",
        label: "Fa0/1 maska",
  ...
  },
  {
    ...
    fields: [
      {
        key: "privA",
        label: "10.5.5.5 je privátní?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "ANO",
        hint: "10.0.0.0/8 je privátní",
      },
      {
        key: "privB",
        label: "172.32.0.1 je privátní?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "NE",
        hint: "Privátní je 172.16–31, ne 172.32",
      },
      {
        key: "privC",
        label: "192.168.0.1 je privátní?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "ANO",
        hint: "192.168.0.0/16 je privátní",
      },
      {
        key: "privD",
        label: "11.0.0.1 je privátní?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "NE",
        hint: "11.x.x.x je veřejná",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      {
        key: "pool_start",
        label: "Začátek DHCP poolu",
        type: "text",
        answer: "192.168.100.11",
        hint: ".1–.10 rezervováno",
      },
      {
        key: "pool_end",
        label: "Konec DHCP poolu",
        type: "text",
        answer: "192.168.100.254",
        hint: "Poslední použitelná",
      },
  ...
  },
  {
    ...
    fields: [
      {
        key: "d224",
        label: "224.0.0.5 třída",
        type: "select",
        options: ["A", "B", "C", "D", "E", "loopback"],
        answer: "D",
        hint: "224–239 = multicast = D",
      },
      {
        key: "e240",
        label: "240.5.5.5 třída",
        type: "select",
        options: ["A", "B", "C", "D", "E", "loopback"],
        answer: "E",
        hint: "240–255 = experimentální = E",
      },
      {
        key: "lo127",
        label: "127.0.0.1 je",
    ...
    fields: [
      {
        ...
        hint: "252 ve 3. oktetu",
      },
      {
        key: "total",
        label: "Celkem IP adres",
        type: "text",
        answer: "1024",
        hint: "2^10 = 1024",
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "sit2",
        label: "Adresa 2. podsítě",
        type: "text",
        answer: "192.168.50.128",
        hint: "0 + 128 = 128",
      },
      {
        key: "bc2",
        label: "Broadcast 2. podsítě",
        type: "text",
        answer: "192.168.50.255",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "rozsah",
        label: "Rozsah loopback",
        type: "text",
        answer: "127.0.0.0/8",
        hint: "Celý blok 127.x.x.x",
      },
      {
        key: "znama",
        label: "Nejznámější loopback IP",
        type: "text",
        answer: "127.0.0.1",
        hint: "localhost",
      },
      {
        key: "internet",
        label: "Směrovatelný přes internet?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "NE",
        hint: "Nikdy neopustí zařízení",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "PC3 IP adresa",
        type: "text",
        answer: "192.168.200.4",
        hint: "Čtvrtý host = .4",
      },
      { key: "maska", label: "Maska", type: "text", answer: "255.255.255.0" },
      {
        key: "gateway",
        label: "Gateway všech PC",
        type: "text",
        answer: "192.168.200.1",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      {
        key: "inside_local",
        label: "Inside local adresa (příklad)",
        type: "text",
        answer: "192.168.1.0",
        hint: "Privátní IP uvnitř sítě",
      },
      {
        key: "inside_global",
        label: "Inside global adresa",
        type: "text",
        answer: "203.0.113.5",
        hint: "Veřejná IP na WAN rozhraní",
      },
      {
        key: "typ",
        label: "Maska inside local sítě",
        type: "text",
        answer: "255.255.255.0",
        hint: "/24",
      },
  ...
  },
  {
    ...
    fields: [
      {
        key: "superip",
        label: "Supernetová adresa",
        type: "text",
        answer: "192.168.4.0",
        hint: "Nižší z obou = 192.168.4.0",
      },
      {
        key: "superprefix",
        label: "Supernetový prefix",
        type: "text",
        answer: "/23",
        hint: "O 1 méně než /24",
      },
      {
        key: "supermaska",
        label: "Supernet maska",
        type: "text",
        answer: "255.255.254.0",
        hint: "/23 = 254 ve 3. oktetu",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "mac",
        label: "Příklad MAC adresy",
        type: "text",
        answer: "AA:BB:CC:DD:EE:FF",
        hint: "6 oktetů hex oddělených :",
      },
      {
        key: "ll",
        label: "Link-local prefix (IPv4)",
        type: "text",
        answer: "169.254.0.0/16",
        hint: "APIPA = 169.254.x.x",
      },
      {
        key: "broadcast_mac",
        label: "Broadcast MAC adresa",
        type: "text",
  ...
  },
  {
    ...
    fields: [
      {
        key: "maska",
        label: "Maska /20 v decimálním zápisu",
        type: "text",
        answer: "255.255.240.0",
        hint: "11111111.11111111.11110000.00000000",
      },
      {
        key: "hosts",
        label: "Max. hostů",
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "dce",
        label: "DCE IP (první host)",
        type: "text",
        answer: "172.30.0.1",
        hint: "Nastaví hodinový signál",
      },
      {
        key: "dte",
        label: "DTE IP (druhý host)",
        type: "text",
        answer: "172.30.0.2",
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "vrstva",
        label: "OSPF pracuje na vrstvě (OSI)",
        type: "text",
        answer: "3",
        hint: "Síťová vrstva = L3",
      },
      {
        key: "ospf2",
        label: "All OSPF DRs multicast IP",
        type: "text",
        answer: "224.0.0.6",
        hint: "224.0.0.5 = all routers, .6 = DR",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "gw10",
        label: "Gateway VLAN 10",
        type: "text",
        answer: "10.10.10.1",
        hint: "První host v 10.10.10.0/24",
      },
      {
        key: "gw20",
        label: "Gateway VLAN 20",
        type: "text",
        answer: "10.10.20.1",
        hint: "První host v 10.10.20.0/24",
      },
      {
        key: "maska",
        label: "Maska obou VLAN",
        type: "text",
        answer: "255.255.255.0",
      },
      {
        key: "inter_vlan",
        label: "Název techniky mezi-VLAN routingu",
        type: "text",
        answer: "Router-on-a-Stick",
        hint: "Jedno fyzické rozhraní, subinterfaces",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "sit1",
        label: "1. podsíť adresa",
        type: "text",
        answer: "192.168.8.0",
      },
      {
        key: "bc1",
        label: "1. podsíť broadcast",
        type: "text",
        answer: "192.168.8.127",
      },
      {
        key: "sit2",
        label: "2. podsíť adresa",
        type: "text",
        answer: "192.168.8.128",
      },
      {
        key: "bc2",
        label: "2. podsíť broadcast",
        type: "text",
        answer: "192.168.8.255",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Broadcast",
        type: "text",
        answer: "172.16.31.255",
        hint: "172.16.0.0 + 8192 - 1",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "same",
        label: "Komunikace s 192.168.3.200 (bez routeru)?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "ANO",
        hint: "Stejná /24 podsíť",
      },
      {
        key: "diff",
        label: "Komunikace s 10.0.0.5 (bez routeru)?",
        type: "select",
        options: ["ANO", "NE"],
        answer: "NE",
        hint: "Jiná síť = nutný router",
      },
      {
        key: "maska",
        label: "Maska PC",
...
const EMOTIONS = {
  furious: {
    ...
    color: "var(--furious)",
    comment: [
      "To je katastrofa! Přečti si učebnici 10×!",
      "Packet Tracer pláče, já taky.",
      "Jsi poslední, kdo by měl konfigurovat síť.",
    ],
  },
  angry: {
    label: "😠 ANGRY",
    color: "var(--angry)",
    comment: [
      "Tohle nás fakt trápí... Zkus znovu.",
      "Příšerný výsledek. Kde jsi byl na přednáškách?",
      "Packet Tracer se stydí.",
    ],
  },
  medium: {
    label: "😐 MEDIUM",
    color: "var(--medium)",
    comment: [
      "Ujde to, ale mohl bys lépe.",
      "Průměr. Cisco čeká víc.",
      "Ani špatné, ani dobré. Zkus víc.",
    ],
  },
  good: {
    label: "😊 GOOD",
    color: "var(--good)",
    comment: [
      "Hezky! Cisco by tě pochválilo.",
      "To se mi líbí. Pokračuj takhle!",
      "Dobrá práce, ale excellence ještě čeká.",
    ],
  },
  excellent: {
    label: "🤩 EXCELLENT",
    color: "var(--excellent)",
    comment: [
      "BRILLIANT! Jsi Cisco Packet Tracer MASTER!",
      "Packet Tracer se raduje! Skvělý výkon!",
      "Tohle je ten výkon, pro který se žije!",
    ],
  },
};
...
function renderTopology(task) {
  ...
  function device(x, y, type, label, ip = "") {
    ...
    if (ip) {
      ...
      ipl.setAttribute("x", x);
      ipl.setAttribute("y", y + 51);
...
function showFeedback(allCorrect, fields, extraMsg = "") {
  ...
  if (allCorrect) {
    ...
    let wrongInfo = fields
      ...
      .map(
        (f) =>
          `<div class="correct-answers">${f.label}: správně <span>${f.answer}</span></div>`,
      )
      .join("");
...
function showResults() {
  ...
  const avg = state.taskTimes.length
    ? Math.round(
        state.taskTimes.reduce((a, b) => a + b, 0) / state.taskTimes.length,
      )
    : 0;
  ...
  const titles = {
    furious: "Katastrofa!",
    angry: "Potřebuješ více cvičení.",
    medium: "Průměrný výsledek.",
    good: "Pěkná práce!",
...
document.querySelector(".cheatsheet-img").addEventListener(
  "wheel",
  (e) => {
    e.preventDefault();
    const img = e.currentTarget;
